...
cls
echo ------==========================================------
echo You arrive at the Haunted Mansion, Do you decide to...
echo.
echo A) Turn the Doorknob
echo B) Ring the doorbell
echo C) Peek through the keyhole
echo ------==========================================------
echo.
set /p inputHM1=Enter:

if %InputHM1% equ A goto HM2
if %InputHM1% equ a goto HM2
if %InputHM1% equ B goto GameOver1HM1
if %InputHM1% equ b goto GameOver1HM1
if %InputHM1% equ C goto GameOver2HM1
if %InputHM1% equ c goto GameOver2HM1
...
echo Continue? (y/n)
echo ------===========================------
set /p InputGOHM1=Continue?:

if %InputGOHM1% equ Y goto HM1
if %InputGOHM1% equ y goto HM1
if %InputGOHM1% equ n goto startup
if %InputGOHM1% equ N goto startup
...
cls
echo ------===========================------
echo        You peek through the keyhole.
echo        You see a bright light and
echo.       lose your vision, therefore
echo        hindering the ability 
echo        complete your mission.
echo.
echo             GAME OVER!
echo Continue? (y/n)
echo ------===========================------
set /p InputGO2HM1=Continue?:

if %InputGO2HM1% equ Y goto HM1
if %InputGO2HM1% equ y goto HM1
if %InputGO2HM1% equ n goto startup
if %InputGO2HM1% equ N goto startup
